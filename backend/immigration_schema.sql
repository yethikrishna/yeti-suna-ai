...
-- These tables extend the existing Suna database without modifying existing schema
...
-- ALTER TABLE immigration_workflows ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE immigration_documents ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE immigration_agent_memory ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE immigration_email_logs ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE immigration_slack_logs ENABLE ROW LEVEL SECURITY;
