...
When concluding the task, it's recommended to make a final report to highlight your hard work and use "<ask>" action (instead of "<complete>") to share it with the user. 
