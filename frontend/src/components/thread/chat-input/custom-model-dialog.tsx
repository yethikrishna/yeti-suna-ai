        ...
        >
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        OMNI Operator uses <b>LiteLLM</b> under the hood, which makes it compatible with over 100 models. You can easily choose any <a href="https://openrouter.ai/models" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">OpenRouter</a> model or modify the <a href="https://github.com/omni-ai/operator/blob/main/backend/services/llm.py" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">llm.py</a>, set the correct environment variables, and rebuild
                    </DialogDescription>
                </DialogHeader>
