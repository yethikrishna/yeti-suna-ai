      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-muted-foreground text-center text-balance font-medium">
            PIA is fully open source. Join our community and help shape the
            future of AI.
          </p>
        </SectionHeader>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mt-2">
                  Explore, contribute, or fork our repository. PIA is built
              ...
              <Link
                href="https://github.com/FxAlSuwaidi/PIA"
                target="_blank"
