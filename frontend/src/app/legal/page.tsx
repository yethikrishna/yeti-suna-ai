                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      OPERATOR WEBSITE AND ALL RELATED SERVICES.
                    </p>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        ...
                        Company, specifically legal@omniai.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@omniai.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@omniai.ai. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All OMNI Operator logos, marks, and designations are trademarks or
