                ...
                {activeTab === "terms" ? (
                  <div>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>"Site" refers to the OoKoO website, including any related features, content, or applications offered from time to time by the Company.</li>
                      <li>"Service" refers to the OoKoO website and all related services provided by the Company, including the AI-powered agent that helps you accomplish real-world tasks.</li>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">References to our "Services" at OoKoO in this statement include our website, apps, and other products and services. This statement applies to our Services that display or reference this Privacy Statement. Third-party services that we integrate with are governed under their own privacy policies.</p>

                    <p className="text-muted-foreground text-balance mb-6">OoKoO does not collect biometric or identifying information. All data is processed securely and any data is deleted upon account removal.</p>
