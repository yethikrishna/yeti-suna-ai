                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE PIA
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        "Site" refers to the PIA website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the PIA website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      PIA is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All PIA logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE PIA WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      PIA DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at PIA in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      PIA does not collect biometric or identifying
