...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Operator by OMNI',
    description: 'Replay this Agent conversation on Operator by OMNI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Operator by OMNI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Operator by OMNI';
